...
**Instructions**:
1. If creating new document: Write to `docs/PRD.md`
2. If updating existing document: Read from `docs/PRD.md`, then update it
...
Please load and use the SpecGovernor prompt template: `.specgov/prompts/prd-generator.md`
