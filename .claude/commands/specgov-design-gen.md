...
- **Target Document**: `docs/Design-Document.md`
- **Review Reports**: Check `reviews/` directory for previous review reports
  - Pattern: `reviews/{DocumentType}-Review-Report-*.md`

**Instructions**:
1. If creating new document: Write to `docs/Design-Document.md`
2. If updating existing document: Read from `docs/Design-Document.md`, then update it
...
Please load and use the SpecGovernor prompt template: `.specgov/prompts/design-generator.md`
