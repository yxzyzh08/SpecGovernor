---
description: Review Product Requirements Document (PRD)
---
...
- **Document to Review**: `docs/PRD.md`
...
**Instructions**:
1. Read the document from `docs/PRD.md`
...
Please load and use the SpecGovernor prompt template: `.specgov/prompts/prd-reviewer.md`
