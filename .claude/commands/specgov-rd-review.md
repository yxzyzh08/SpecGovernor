---
description: Review Requirements Document (RD)
---
...
**Instructions**:
1. Read the document from `docs/RD.md`
...
Please load and use the SpecGovernor prompt template: `.specgov/prompts/rd-reviewer.md`
